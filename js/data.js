...
// Ilustraciones vectoriales a color (sin imágenes externas, funcionan
// offline). Cada negocio puede sustituirlas por una foto real.
const DECORACIONES = [
  { id: "rodaja-lima", nombre: "Rodaja de lima", grupo: "Cítricos", como: "Corta una rueda fina de lima y engánchala en el borde o déjala flotar.",
    svg: '<svg viewBox="0 0 64 64"><defs><radialGradient id="d-rl" cx="42%" cy="38%"><stop offset="0" stop-color="#eaf7cc"/><stop offset="1" stop-color="#9fd155"/></radialGradient></defs><circle cx="32" cy="32" r="25" fill="#3f7a1e"/><circle cx="32" cy="32" r="21.5" fill="#dcefb4"/><circle cx="32" cy="32" r="20" fill="url(#d-rl)"/><g stroke="#ffffff" stroke-width="1.6" opacity=".85"><line x1="32" y1="32" x2="51" y2="32"/><line x1="32" y1="32" x2="47.4" y2="43.2"/><line x1="32" y1="32" x2="37.9" y2="50.1"/><line x1="32" y1="32" x2="26.1" y2="50.1"/><line x1="32" y1="32" x2="16.6" y2="43.2"/><line x1="32" y1="32" x2="13" y2="32"/><line x1="32" y1="32" x2="16.6" y2="20.8"/><line x1="32" y1="32" x2="26.1" y2="13.9"/><line x1="32" y1="32" x2="37.9" y2="13.9"/><line x1="32" y1="32" x2="47.4" y2="20.8"/></g><circle cx="32" cy="32" r="3" fill="#eef8d6"/><ellipse cx="24" cy="21" rx="6" ry="3.5" fill="#fff" opacity=".35" transform="rotate(-35 24 21)"/></svg>' },
  { id: "rodaja-limon", nombre: "Rodaja de limón", grupo: "Cítricos", como: "Rueda fina de limón al borde del vaso.",
    svg: '<svg viewBox="0 0 64 64"><defs><radialGradient id="d-rli" cx="42%" cy="38%"><stop offset="0" stop-color="#fdf6cf"/><stop offset="1" stop-color="#f2d24b"/></radialGradient></defs><circle cx="32" cy="32" r="25" fill="#d1a416"/><circle cx="32" cy="32" r="21.5" fill="#faf4cd"/><circle cx="32" cy="32" r="20" fill="url(#d-rli)"/><g stroke="#ffffff" stroke-width="1.6" opacity=".9"><line x1="32" y1="32" x2="51" y2="32"/><line x1="32" y1="32" x2="47.4" y2="43.2"/><line x1="32" y1="32" x2="37.9" y2="50.1"/><line x1="32" y1="32" x2="26.1" y2="50.1"/><line x1="32" y1="32" x2="16.6" y2="43.2"/><line x1="32" y1="32" x2="13" y2="32"/><line x1="32" y1="32" x2="16.6" y2="20.8"/><line x1="32" y1="32" x2="26.1" y2="13.9"/><line x1="32" y1="32" x2="37.9" y2="13.9"/><line x1="32" y1="32" x2="47.4" y2="20.8"/></g><circle cx="32" cy="32" r="3" fill="#fdf8dd"/><ellipse cx="24" cy="21" rx="6" ry="3.5" fill="#fff" opacity=".4" transform="rotate(-35 24 21)"/></svg>' },
  { id: "rodaja-naranja", nombre: "Rodaja de naranja", grupo: "Cítricos", como: "Media rueda de naranja pinchada o al borde.",
    svg: '<svg viewBox="0 0 64 64"><defs><radialGradient id="d-rn" cx="50%" cy="85%"><stop offset="0" stop-color="#ffd9a3"/><stop offset="1" stop-color="#f08c1f"/></radialGradient></defs><path d="M7 40a25 25 0 0 1 50 0Z" fill="#d96f12"/><path d="M10.5 40a21.5 21.5 0 0 1 43 0Z" fill="#ffe3c2"/><path d="M12 40a20 20 0 0 1 40 0Z" fill="url(#d-rn)"/><g stroke="#ffffff" stroke-width="1.6" opacity=".85"><line x1="32" y1="40" x2="12" y2="40"/><line x1="32" y1="40" x2="14.7" y2="30"/><line x1="32" y1="40" x2="22" y2="22.7"/><line x1="32" y1="40" x2="32" y2="20"/><line x1="32" y1="40" x2="42" y2="22.7"/><line x1="32" y1="40" x2="49.3" y2="30"/><line x1="32" y1="40" x2="52" y2="40"/></g><ellipse cx="24" cy="28" rx="5" ry="3" fill="#fff" opacity=".3" transform="rotate(-30 24 28)"/></svg>' },
  { id: "gajo-lima", nombre: "Gajo de lima", grupo: "Cítricos", como: "Cuña de lima para exprimir y decorar.",
    svg: '<svg viewBox="0 0 64 64"><path d="M12 46A26 26 0 0 1 50 14L12 46Z" fill="#dff0c0"/><path d="M13.8 43.2A23.5 23.5 0 0 1 47.5 16.4L50 14 12 46Z" fill="#c3e494"/><path d="M12 46A26 26 0 0 1 50 14" fill="none" stroke="#3f7a1e" stroke-width="5.5" stroke-linecap="round"/><g stroke="#ffffff" stroke-width="1.5" opacity=".85"><path d="M22.5 37.2l-5.4-6.4"/><path d="M32 29.2l-5.4-6.4"/><path d="M41.5 21.2l-5.4-6.4"/></g></svg>' },
  { id: "twist-naranja", nombre: "Twist de naranja", grupo: "Cítricos", como: "Piel de naranja en espiral; exprime los aceites sobre la copa.",
    svg: '<svg viewBox="0 0 64 64"><defs><linearGradient id="d-tn" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ffb347"/><stop offset="1" stop-color="#e8791b"/></linearGradient></defs><path d="M44 12C26 12 16 24 16 36s10 20 20 20 16-8 16-16-6-14-14-14-10 5-10 10 3 8 7 8" fill="none" stroke="url(#d-tn)" stroke-width="7" stroke-linecap="round"/><path d="M44 12C26 12 16 24 16 36s10 20 20 20 16-8 16-16-6-14-14-14-10 5-10 10 3 8 7 8" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" opacity=".3"/></svg>' },
  { id: "twist-limon", nombre: "Twist de limón", grupo: "Cítricos", como: "Espiral de piel de limón sobre el borde.",
    svg: '<svg viewBox="0 0 64 64"><defs><linearGradient id="d-tl" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f9e97e"/><stop offset="1" stop-color="#dfb31c"/></linearGradient></defs><path d="M44 12C26 12 16 24 16 36s10 20 20 20 16-8 16-16-6-14-14-14-10 5-10 10 3 8 7 8" fill="none" stroke="url(#d-tl)" stroke-width="7" stroke-linecap="round"/><path d="M44 12C26 12 16 24 16 36s10 20 20 20 16-8 16-16-6-14-14-14-10 5-10 10 3 8 7 8" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" opacity=".35"/></svg>' },
  { id: "cereza", nombre: "Cereza", grupo: "Frutas", como: "Cereza al marrasquino, pinchada o al fondo.",
    svg: '<svg viewBox="0 0 64 64"><defs><radialGradient id="d-cz" cx="38%" cy="32%"><stop offset="0" stop-color="#ff6b6b"/><stop offset="1" stop-color="#a01824"/></radialGradient></defs><path d="M30 20c4-9 12-13 22-15" fill="none" stroke="#6b4423" stroke-width="2.5" stroke-linecap="round"/><path d="M40 8c5-3 8-3 12-2-3 3-7 4-12 2Z" fill="#4a8f3c"/><circle cx="24" cy="44" r="12" fill="url(#d-cz)"/><circle cx="42" cy="46" r="10.5" fill="url(#d-cz)"/><ellipse cx="20" cy="39" rx="4" ry="2.6" fill="#fff" opacity=".5" transform="rotate(-30 20 39)"/><ellipse cx="39" cy="42" rx="3.2" ry="2" fill="#fff" opacity=".4" transform="rotate(-30 39 42)"/></svg>' },
  { id: "fresa", nombre: "Fresa", grupo: "Frutas", como: "Fresa entera con corte para el borde, o en láminas.",
    svg: '<svg viewBox="0 0 64 64"><defs><linearGradient id="d-fr" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ff5a6e"/><stop offset="1" stop-color="#c11733"/></linearGradient></defs><path d="M18 26c0-4 6-6 14-6s14 2 14 6c0 14-9 32-14 32S18 40 18 26Z" fill="url(#d-fr)"/><path d="M17 22l6 5 4-6 5 6 4-6 6 5c-3 3-9 4-15 4s-11-1-16-4Z" fill="#4a9d3f"/><path d="M32 14v6" stroke="#3f7a1e" stroke-width="2.5" stroke-linecap="round"/><g fill="#ffe08a"><circle cx="26" cy="32" r="1.3"/><circle cx="37" cy="33" r="1.3"/><circle cx="31" cy="39" r="1.3"/><circle cx="24" cy="41" r="1.3"/><circle cx="39" cy="41" r="1.3"/><circle cx="31" cy="48" r="1.3"/><circle cx="27" cy="52" r="1.1"/><circle cx="35" cy="52" r="1.1"/></g><ellipse cx="25" cy="29" rx="3.4" ry="2.2" fill="#fff" opacity=".35" transform="rotate(-25 25 29)"/></svg>' },
  { id: "pina", nombre: "Trozo de piña", grupo: "Frutas", como: "Cuña de piña al borde, sola o con cereza.",
    svg: '<svg viewBox="0 0 64 64"><defs><linearGradient id="d-pn" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffe27a"/><stop offset="1" stop-color="#eda92c"/></linearGradient></defs><path d="M32 8 48 50H16Z" fill="url(#d-pn)"/><path d="M32 16 42 46H22Z" fill="#fff3c0" opacity=".45"/><g stroke="#d99a24" stroke-width="1.4"><path d="M27 30l10 12M37 30 27 42"/><path d="M24 38h16"/></g><path d="M14 50h36v4.5c0 2.3-1.7 3.5-4 3.5H18c-2.3 0-4-1.2-4-3.5Z" fill="#7a4a21"/><g stroke="#c98d4c" stroke-width="1.7" stroke-linecap="round"><path d="M19 54h3.5M27 54h3.5M35 54h3.5M43 54h3.5"/></g></svg>' },
  { id: "rodaja-pepino", nombre: "Rodaja de pepino", grupo: "Botánicos", como: "Lámina fina de pepino dentro del gin tonic o al borde.",
    svg: '<svg viewBox="0 0 64 64"><defs><radialGradient id="d-pp" cx="45%" cy="42%"><stop offset="0" stop-color="#f7fbe9"/><stop offset="1" stop-color="#dcecc2"/></radialGradient></defs><circle cx="32" cy="32" r="25" fill="#3f7a1e"/><circle cx="32" cy="32" r="21" fill="url(#d-pp)"/><g fill="#c9dfa0"><ellipse cx="32" cy="22" rx="2.3" ry="4" /><ellipse cx="40.7" cy="27" rx="2.3" ry="4" transform="rotate(60 40.7 27)"/><ellipse cx="40.7" cy="37" rx="2.3" ry="4" transform="rotate(120 40.7 37)"/><ellipse cx="32" cy="42" rx="2.3" ry="4"/><ellipse cx="23.3" cy="37" rx="2.3" ry="4" transform="rotate(60 23.3 37)"/><ellipse cx="23.3" cy="27" rx="2.3" ry="4" transform="rotate(120 23.3 27)"/></g><circle cx="32" cy="32" r="2.5" fill="#e8f2d4"/><ellipse cx="24" cy="21" rx="5.5" ry="3" fill="#fff" opacity=".4" transform="rotate(-35 24 21)"/></svg>' },
  { id: "menta", nombre: "Ramillete de menta", grupo: "Botánicos", como: "Golpea la menta en la mano y clávala como sombrilla verde.",
    svg: '<svg viewBox="0 0 64 64"><defs><linearGradient id="d-mn" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#7ed957"/><stop offset="1" stop-color="#2f7d32"/></linearGradient></defs><path d="M32 56V30" stroke="#3f7a1e" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M32 33C20 33 14 26 13 14c12 0 19 7 19 19Z" fill="url(#d-mn)"/><path d="M32 33c12 0 18-7 19-19-12 0-19 7-19 19Z" fill="url(#d-mn)"/><path d="M32 40C24 40 20 35 19 27c9 0 13 5 13 13Z" fill="url(#d-mn)"/><path d="M20 17q7 5 12 16M45 17q-7 5-13 16M22 29q6 3 10 11" stroke="#1f5a24" stroke-width="1.2" fill="none" opacity=".55"/></svg>' },
  { id: "romero", nombre: "Ramita de romero", grupo: "Botánicos", como: "Rama de romero, se puede flamear ligeramente por el aroma.",
    svg: '<svg viewBox="0 0 64 64"><path d="M32 57V10" stroke="#5d7a3a" stroke-width="2.6" stroke-linecap="round"/><g fill="#4a9d3f"><ellipse cx="26" cy="15" rx="1.7" ry="6" transform="rotate(38 26 15)"/><ellipse cx="38" cy="15" rx="1.7" ry="6" transform="rotate(-38 38 15)"/><ellipse cx="25" cy="24" rx="1.7" ry="6.5" transform="rotate(42 25 24)"/><ellipse cx="39" cy="24" rx="1.7" ry="6.5" transform="rotate(-42 39 24)"/><ellipse cx="24.5" cy="33" rx="1.7" ry="7" transform="rotate(46 24.5 33)"/><ellipse cx="39.5" cy="33" rx="1.7" ry="7" transform="rotate(-46 39.5 33)"/><ellipse cx="24.5" cy="42" rx="1.7" ry="7" transform="rotate(48 24.5 42)"/><ellipse cx="39.5" cy="42" rx="1.7" ry="7" transform="rotate(-48 39.5 42)"/><ellipse cx="32" cy="9" rx="1.7" ry="5.5"/></g><g fill="#7ed957" opacity=".7"><ellipse cx="27" cy="14" rx="1" ry="4.5" transform="rotate(38 27 14)"/><ellipse cx="37" cy="14" rx="1" ry="4.5" transform="rotate(-38 37 14)"/></g></svg>' },
  { id: "borde-sal", nombre: "Borde de sal", grupo: "Bordes", como: "Humedece el borde con lima y gíralo sobre sal (solo media vuelta).",
    svg: '<svg viewBox="0 0 64 64"><path d="M12 16h40L32 40Z" fill="#cfe4f2"/><path d="M16.5 19.5h31L32 36.5Z" fill="#a8d4ea"/><path d="M12 16h40L32 40Z" fill="none" stroke="#8fb0c9" stroke-width="2" stroke-linejoin="round"/><path d="M32 40v13M21 55.5h22" stroke="#8fb0c9" stroke-width="3" fill="none" stroke-linecap="round"/><g fill="#ffffff"><circle cx="12" cy="14.5" r="1.7"/><circle cx="17" cy="13.6" r="1.5"/><circle cx="22" cy="14.6" r="1.7"/><circle cx="27" cy="13.5" r="1.5"/><circle cx="32" cy="14.6" r="1.7"/><circle cx="37" cy="13.5" r="1.5"/><circle cx="42" cy="14.6" r="1.7"/><circle cx="47" cy="13.6" r="1.5"/><circle cx="52" cy="14.5" r="1.7"/></g></svg>' },
  { id: "borde-azucar", nombre: "Borde de azúcar", grupo: "Bordes", como: "Igual que la sal pero con azúcar; ideal para cítricos dulces.",
    svg: '<svg viewBox="0 0 64 64"><path d="M12 16h40L32 40Z" fill="#f4e6c6"/><path d="M16.5 19.5h31L32 36.5Z" fill="#eaca8b"/><path d="M12 16h40L32 40Z" fill="none" stroke="#c9a86b" stroke-width="2" stroke-linejoin="round"/><path d="M32 40v13M21 55.5h22" stroke="#c9a86b" stroke-width="3" fill="none" stroke-linecap="round"/><g fill="#fffbe8"><circle cx="12" cy="14.5" r="1.7"/><circle cx="17" cy="13.6" r="1.5"/><circle cx="22" cy="14.6" r="1.7"/><circle cx="27" cy="13.5" r="1.5"/><circle cx="32" cy="14.6" r="1.7"/><circle cx="37" cy="13.5" r="1.5"/><circle cx="42" cy="14.6" r="1.7"/><circle cx="47" cy="13.6" r="1.5"/><circle cx="52" cy="14.5" r="1.7"/></g></svg>' },
  { id: "granos-cafe", nombre: "Granos de café", grupo: "Especias", como: "3 granos de café sobre la espuma (espresso martini).",
    svg: '<svg viewBox="0 0 64 64"><defs><radialGradient id="d-gc" cx="38%" cy="32%"><stop offset="0" stop-color="#a06a35"/><stop offset="1" stop-color="#4a2a12"/></radialGradient></defs><g transform="rotate(-22 22 24)"><ellipse cx="22" cy="24" rx="8" ry="10.5" fill="url(#d-gc)"/><path d="M22 15q4 9 0 18" stroke="#31200e" stroke-width="2.2" fill="none"/></g><g transform="rotate(24 43 28)"><ellipse cx="43" cy="28" rx="8" ry="10.5" fill="url(#d-gc)"/><path d="M43 19q4 9 0 18" stroke="#31200e" stroke-width="2.2" fill="none"/></g><ellipse cx="31" cy="46" rx="8" ry="10.5" fill="url(#d-gc)"/><path d="M31 37q4 9 0 18" stroke="#31200e" stroke-width="2.2" fill="none"/><ellipse cx="19" cy="18" rx="2.6" ry="1.6" fill="#fff" opacity=".3" transform="rotate(-30 19 18)"/></svg>' },
  { id: "canela", nombre: "Rama de canela", grupo: "Especias", como: "Rama de canela, se puede rallar o flamear por encima.",
    svg: '<svg viewBox="0 0 64 64"><defs><linearGradient id="d-ca" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#b57937"/><stop offset="1" stop-color="#845120"/></linearGradient></defs><g transform="rotate(24 32 32)"><rect x="27" y="8" width="10" height="48" rx="5" fill="url(#d-ca)"/><path d="M32 10v44" stroke="#6b3d16" stroke-width="1.6"/><path d="M28.5 10c2 1.6 5 1.6 7 0M28.5 54c2-1.6 5-1.6 7 0" stroke="#e0b070" stroke-width="1.6" fill="none"/></g><g transform="rotate(-18 32 32)"><rect x="27" y="12" width="9" height="40" rx="4.5" fill="url(#d-ca)" opacity=".92"/><path d="M31.5 14v36" stroke="#6b3d16" stroke-width="1.4"/></g></svg>' },
  { id: "anis", nombre: "Anís estrellado", grupo: "Especias", como: "Estrella de anís flotando, aroma especiado.",
    svg: '<svg viewBox="0 0 64 64"><g fill="#8a5a2b" stroke="#6b4423" stroke-width="1"><ellipse cx="32" cy="15" rx="4.2" ry="11.5"/><ellipse cx="32" cy="15" rx="4.2" ry="11.5" transform="rotate(45 32 32)"/><ellipse cx="32" cy="15" rx="4.2" ry="11.5" transform="rotate(90 32 32)"/><ellipse cx="32" cy="15" rx="4.2" ry="11.5" transform="rotate(135 32 32)"/><ellipse cx="32" cy="15" rx="4.2" ry="11.5" transform="rotate(180 32 32)"/><ellipse cx="32" cy="15" rx="4.2" ry="11.5" transform="rotate(225 32 32)"/><ellipse cx="32" cy="15" rx="4.2" ry="11.5" transform="rotate(270 32 32)"/><ellipse cx="32" cy="15" rx="4.2" ry="11.5" transform="rotate(315 32 32)"/></g><g fill="#d9b98a"><circle cx="32" cy="11" r="2.1"/><circle cx="46.8" cy="17.2" r="2.1"/><circle cx="53" cy="32" r="2.1"/><circle cx="46.8" cy="46.8" r="2.1"/><circle cx="32" cy="53" r="2.1"/><circle cx="17.2" cy="46.8" r="2.1"/><circle cx="11" cy="32" r="2.1"/><circle cx="17.2" cy="17.2" r="2.1"/></g><circle cx="32" cy="32" r="5.5" fill="#6b4423"/><circle cx="30.5" cy="30.5" r="1.6" fill="#a97e4b"/></svg>' },
  { id: "aceituna", nombre: "Aceituna", grupo: "Salados", como: "1-3 aceitunas en palillo (dry martini).",
    svg: '<svg viewBox="0 0 64 64"><defs><radialGradient id="d-ac" cx="38%" cy="32%"><stop offset="0" stop-color="#b8d45e"/><stop offset="1" stop-color="#5d7a1f"/></radialGradient></defs><path d="M47 9 28 37" stroke="#d9c9a8" stroke-width="2.6" stroke-linecap="round"/><circle cx="47" cy="9" r="3" fill="#e8dcc0"/><ellipse cx="28" cy="44" rx="11.5" ry="14" fill="url(#d-ac)"/><circle cx="28" cy="36.5" r="4" fill="#c1440e"/><circle cx="27" cy="35.5" r="1.3" fill="#e8703d"/><ellipse cx="23" cy="40" rx="3.4" ry="4.5" fill="#fff" opacity=".28" transform="rotate(-20 23 40)"/></svg>' },
];
